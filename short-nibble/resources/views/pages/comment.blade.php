...
<section class="flex flex-wrap flex-row justify-center">
    <div class="flex flex-wrap flex-col items-center">
        ...
        <section class=" mx-10 my-5 px-10 py-3 flex flex-wrap flex-col justify-center">
            ...
            <br>
            <section class="px-10 py-3 border-solid border-2 rounded-xl border-amber-100">
                ...
                <form method="POST" action="pages.comment" class="w-full max-w-xl bg-white rounded-lg px-4 pt-2">
                    @csrf
